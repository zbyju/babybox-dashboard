...
import { IssueEdit } from "@/components/issue-edit";
        ...
        {isLoading ? (
          ...
          <div className="flex flex-row flex-wrap gap-6 lg:flex-nowrap">
              ...
              <div className="rounded-xl border border-border">
                <div className="flex flex-col gap-4 p-6">
                  ...
                  <div className="flex flex-col gap-8">
                    <div>
                      <h5 className="mb-2 text-xl font-medium">Popis chyby</h5>
                  ...
                  <div className="mt-5 flex flex-row flex-wrap items-center gap-6">
                    <div>
                      ...
                      <Badge
                        style={{
                          backgroundColor: colorizePriority(
                            issue.priority || "",
                          ),
                        }}
                      >
                    ...
                    <div>
                      ...
                      <Badge
                        style={{
                          backgroundColor: colorizeSeverity(
                            issue.severity || "",
                          ),
                        }}
                      >
                  ...
                  <div key={h.timestamp.getTime()}>
                    {h.type === "state" ? (
                      <div className="flex flex-row">
                        <div className="flex flex-col justify-center">
                          <div
                            className={`ml-[18px] w-[4px] flex-grow ${h.username === "SYSTEM" ? "bg-gray-500 dark:bg-gray-700" : "bg-slate-300 dark:bg-slate-600"}`}
                          ></div>
                          <Avatar>
                            <AvatarFallback
                              className={
                        ...
                        <div className="ml-4 py-4">
                          ...
                          <h5>
                            ...
                            <Badge
                              ...
                              style={{
                                backgroundColor: colorizeStatus(h.value),
                              }}
                            >
            ...
            <div className="w-full lg:w-[300px]">
              <IssueEdit issue={issue} onChange={() => mutate()} />
            </div>
          </div>
        )}
      </div>
