...
export default function IssuePageClient({ id }: IssuePageClientProps) {
  ...
  const {
    ...
    error,
    mutate,
  } = useSWR(["issues/" + id, token], ([_, token]) => issueFetcher(token, id));
        ...
        {isLoading ? (
          ...
          <>
            <BreadcrumbsDashboard
              ...
              links={[
                {
                  href: `/dashboard/babybox/${issue.slug}/issue`,
                  label: "Seznam chyb",
                },
              ]}
            />
