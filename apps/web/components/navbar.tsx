...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <nav className="mobile-nav visible fixed bottom-0 z-50 w-screen border-collapse border-t border-slate-400 bg-slate-100 dark:border-slate-700 dark:bg-slate-800 lg:hidden">
