...
export default function Navbar() {
  ...
  return (
    <nav className="w-screen border-collapse border-b border-b-slate-100 dark:border-b-slate-800">
      <div className="flex flex-row items-center justify-start gap-10 px-[16%] py-2">
